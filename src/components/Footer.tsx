      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex gap-3 mt-1">
            ...
            <a href="https://www.instagram.com/estatehood_/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-pink-400">
            ...
            <a href="https://youtube.com/" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="hover:text-red-400">
